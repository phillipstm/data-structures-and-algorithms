...
const sortByChildren = ('this.name'); => {objs.sort.min((c,d) => c.children || d.house);};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 2

Write a function named containsW
...
const isNum = (input) => {if isNum()=int;
  else: false
  // Solution code here...
};
