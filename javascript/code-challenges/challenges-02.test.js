...
Write a function named raisedToTheThird x
that takes in an array of numbers x
and returns a new array of
 each of those numbers raised to the 3rd power
 (hint: look up Math.pow()). Use forEach to solve this problem.

------------------------------------------------------------------------------------------------ */

const raisedToTheThird = (arr) => {this.raisedToTheThird(arr);};
...
that, given an array of numbers,
 uses map to return a new array with
